                    ...
                    <div className="relative lg:w-4/5 mx-auto p-6 flex flex-wrap">
                        ...
                        <div className="relative lg:w-1/2 w-full z-10">
                            ...
                            <div className="grid grid-col-3 grid-flow-col gap-4 justify-evenly mt-6">
                                { data.Screenshot1 !== '' && <img className=" aspect-square object-cover" src={data.Screenshot1} />}
                                { data.Screenshot2 !== '' && <img className=" aspect-square object-cover" src={data.Screenshot2} />}
                                { data.Screenshot3 !== '' && <img className=" aspect-square object-cover" src={data.Screenshot3} />}
                                { data.Screenshot4 !== '' && <img className=" aspect-square object-cover" src={data.Screenshot4} />}
                            </div>
                        </div>
                        ...
                        <div className="relative lg:w-1/2 w-full lg:p-10 lg:py-6 mt-6 lg:mt-16 z-10">
                            ...
                            <a target="_blank" rel="noreferrer" href={data.PSStoreURL}>
                            ...
                            <h2 className="text-xl title-font text-gray-500 mt-6">Preview Video</h2>
                            <div className="py-4">
                                <div className="w-full border-t border-gray-300"></div>
                            </div>
                            <div>
                                <ReactPlayer url={ data.PreviewVideo } width="100%" height="100%" controls="false" />
                            </div>
